<?php
  ...
  */
  class AccessToken {
    ...
    /**
    * Get the access token from Bing.
    ...
    */
    function getAccessToken() {
      ...
      curl_setopt($ch, CURLOPT_POSTFIELDS, $paramArr);  // Set the parameters
      curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);  // force "curl_exec" to return the actual result instead of "TRUE" on success
